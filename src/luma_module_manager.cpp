...
#include "luma_module_manager.h"   // pulls in the LumaModuleManager class declaration
#include <GLES3/gl3.h>
#include <vector>
#include <string>
#include <cmath>
...
// ============================================================================
// LumaModuleManager – singleton accessor & method bodies
// Declared in include/luma_module_manager.h, implemented here.
// ============================================================================
static LumaModuleManager& g_moduleManagerInstance() {
    static LumaModuleManager instance;
    return instance;
}

LumaModuleManager& LumaGetModuleManager() {
    return g_moduleManagerInstance();
}

void LumaModuleManager::tick(float dt) {
    for (auto& mod : modules) {
        if (mod.enabled && mod.on_tick) {
            mod.on_tick(dt);
        }
    }
}
...
// ============================================================================
// UI MODULE CARD DATA STRUCTURE (menu-only; distinct from the runtime LumaModule)
// ============================================================================
struct LumaUIModule {
    std::string name;
...
// MODULE REGISTRY
// ============================================================================
static std::vector<LumaUIModule> g_modules = {
    // Combat Modules
...
// RENDER MODULE CARD
// ============================================================================
static void RenderModuleCard(LumaUIModule& mod) {
...
// ============================================================================
// DOBBY HOOK STUB (C linkage – callable from luma_linux.c)
// ============================================================================
int DobbyHook(void* target, void* replace, void** result) {
    *result = target;  // No-op stub; replace with real Dobby at link time
    return 0;
}
